...
//void fillElectronChargeFlip(vector<const xAOD::Electron*> reco_electrons, vector<int>& El_chargeFlip)
inline void fillElectronChargeFlip( xAOD::ElectronContainer* reco_electrons, const xAOD::TruthParticleContainer* container_particles, int mcChannelNumber) //, vector<int>& El_chargeFlip)
{
    //El_chargeFlip.clear();
