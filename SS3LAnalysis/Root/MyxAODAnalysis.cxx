...
EL::StatusCode MyxAODAnalysis :: initialize ()
{
  ...
  string prw_config_loc = "dev/SUSYTools/PRW_AUTOCONFIG_SIM/files/"; /// /cvmfs/atlas.cern.ch/repo/sw/database/GroupData/dev/SUSYTools/PRW_AUTOCONFIG/files/
...
EL::StatusCode MyxAODAnalysis :: execute ()
{
  ...
  /// for debugging !!!!
  if(false && !(tEventNumber==66846 || tEventNumber==89305 || tEventNumber==35159)) return EL::StatusCode::SUCCESS; /// go to next event
  ...
  else
  {
    ...
    if(DEBUG) Info( APP_NAME, " MET TST px = %f py = %f ", (*mettst)["Final"]->mpx(), (*mettst)["Final"]->mpy() );
