...
os.chdir(os.environ["BASEDIR"]+"/Utils/")
table = "submit/{0}".format(options.DQ2)
...
for line in open(table):
    ...
    command = "python /lustre/scratch/epp/atlas/na337/workdir/Analysis2018/SS3L/Framework/Rel21-2-v35/DiLeptonRel21/Utils/run.py"\
